...
function mapStateToProps ({ stems, roots, affixes, bibliography, texts, audiosets, errors }) {
  return {
    loading: stems === null || roots === null || affixes === null || bibliography === null || texts === null || audiosets === null,
    errors: errors
  }
}
